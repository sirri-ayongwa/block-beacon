...
export function ResetPasswordPage() {
  ...
  // Resolve the intended role at run-time (browser) only
  const getInitialRole = () => {
    if (roleParam === "moderator") return "moderator" as const;
    if (typeof window !== "undefined") {
      const stored = window.localStorage.getItem("bb.reset_role");
      if (stored === "moderator") return "moderator" as const;
    }
